...
<div id="content">
    ...
    <form action=" " method="post" autocomplete="on">
        <p>
            <label for="username" class="icon-user"> <?php
        ...
        <p>
            <label for="usermail" class="icon-envelope"><?php
        ...
        <p>
            <label for="usersite" class="icon-link"><?php
		echo $this->Form->input('phone');?></label>
            
        </p>

        <p>
            <label for="usersite" class="icon-link"><?php
		echo $this->Form->input('Adress');?></label>
            
        </p>

        <p>
            <label for="message" class="icon-comment"> <?php
        ...
        <p class="indication">Fields with
            <span class="required"> * </span><?php echo $this->Form->end(__('Send your email!!')); ?>
</p>
