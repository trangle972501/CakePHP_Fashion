...
<?php echo $this->Form->create('Order'); ?>
	...
	<?php
		...
		echo $this->Form->input('receiverdate', array('type'=>'text','label' => 'Ngày nhận', 'class' => 'datepicker'));
		...
		echo $this->Form->input('createorder', array('type'=>'text','label' => 'Ngày nhận', 'class' => 'datepicker'));
