...
<div class="posts index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('top'); ?></th>
			<th><?php echo $this->Paginator->sort('bottom1'); ?></th>
			<th><?php echo $this->Paginator->sort('bottom2'); ?></th>
	...
	<tr>
		...
		<td><?php
			...
			{
				echo "Khong duoc chon";
			}
		?>
</td>
		<td><?php echo h($post['Post']['bottom1']); ?>&nbsp;
		</td>
